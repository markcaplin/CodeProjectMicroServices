...
var InventoryManagementNavBarComponent = /** @class */ (function () {
    ...
    InventoryManagementNavBarComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './inventory-management-nav-bar.component.html',
            styleUrls: ['./inventory-management-nav-bar.component.css']
        }),
        __metadata("design:paramtypes", [])
    ], InventoryManagementNavBarComponent);
    return InventoryManagementNavBarComponent;
}());
exports.InventoryManagementNavBarComponent = InventoryManagementNavBarComponent;
//# sourceMappingURL=inventory-management-nav-bar.component.js.map