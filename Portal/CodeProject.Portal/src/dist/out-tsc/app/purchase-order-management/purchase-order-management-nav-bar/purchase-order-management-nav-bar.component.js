...
var PurchaseOrderManagementNavBarComponent = /** @class */ (function () {
    ...
    PurchaseOrderManagementNavBarComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './purchase-order-management-nav-bar.component.html',
            styleUrls: ['./purchase-order-management-nav-bar.component.css']
        }),
        __metadata("design:paramtypes", [])
    ], PurchaseOrderManagementNavBarComponent);
    return PurchaseOrderManagementNavBarComponent;
}());
exports.PurchaseOrderManagementNavBarComponent = PurchaseOrderManagementNavBarComponent;
//# sourceMappingURL=purchase-order-management-nav-bar.component.js.map